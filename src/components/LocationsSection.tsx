...
const categories = [
  ...
  },
  {
    ...
    icon: Waves,
    cities: ["Calabar", "Warri", "Uyo", "Bonny", "Lekki", "Badagry"],
  },
  {
    title: "Emerging markets",
    description: "Affordable growth areas with high potential",
    icon: TreePine,
    cities: ["Asaba", "Awka", "Abeokuta", "Ilorin", "Jos", "Owerri"],
  },
  {
    title: "Popular locations",
    description: "Move to a property hotspot",
    icon: MapPin,
    cities: ["Lekki Phase 1", "Ikoyi", "Victoria Island", "Maitama", "Wuse 2", "GRA Ikeja"],
    showAllLink: true,
  },
];
