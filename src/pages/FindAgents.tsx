...
const FindAgents = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Find Estate Agents in Nigeria" description="Compare top local estate agents across Nigeria. Find verified agents for buying, selling, or renting property." canonical="/find-agents" ogImage="https://propatihub.lovable.app/og-find-agents.png" />
