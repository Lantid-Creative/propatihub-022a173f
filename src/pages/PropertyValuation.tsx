...
const PropertyValuation = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Free Property Valuation in Nigeria" description="Get an instant estimate of your property's value. Free online valuations for houses, apartments, and land across Nigeria." canonical="/property-valuation" ogImage="https://propatihub.lovable.app/og-valuation.png" />
