...
const About = () => (
  <div className="min-h-screen flex flex-col bg-background">
    <PageSEO title="About PropatiHub" <PageSEO title="About PropatiHub" description="Learn about Nigeria's trusted property platform connecting buyers, renters, agents, and agencies across all 36 states + FCT." canonical="/about" /> canonical="/about" />
    <Navbar />
